...
def search_fr():
    ...
    search_button1 = Button(search_frame, text='НАЙТИ', bg='grey55', fg='white', width=25, command=search)
...
def add_fr():
    ...
    add_button1 = Button(add_frame, text='ДОБАВИТЬ', bg='grey55', fg='white', width=25, command=add)
...
def edit_fr():
    ...
    edit_button1 = Button(edit_frame, text='ИЗМЕНИТЬ', bg='grey55', fg='white', width=25, command=edit)
...
def expand_fr():
    ...
    expand_button1 = Button(expand_frame, text='РАСШИРИТЬ', bg='grey55', fg='white', width=25, command=expand)
...
def delete_fr():
    ...
    delete_button1 = Button(delete_frame, text='УДАЛИТЬ', bg='grey55', fg='white', width=25, command=delete)
...
def narrow_fr():
    ...
    narrow_button1 = Button(narrow_frame, text='СУЗИТЬ', bg='grey55', fg='white', width=25, command=narrow)
...
search_button = Button(main_frame, text='ПОИСК', bg='grey55', fg='white', width=30, command=search_fr)
add_button = Button(main_frame, text='ДОБАВЛЕНИЕ', bg='grey55', fg='white', width=30, command=add_fr)
edit_button = Button(main_frame, text='ИЗМЕНЕНИЕ', bg='grey55', fg='white', width=30, command=edit_fr)
expand_button = Button(main_frame, text='РАСШИРЕНИЕ', bg='grey55', fg='white', width=30, command=expand_fr)
delete_button = Button(main_frame, text='УДАЛЕНИЕ', bg='grey55', fg='white', width=30, command=delete_fr)
narrow_button = Button(main_frame, text='СУЖЕНИЕ', bg='grey55', fg='white', width=30, command=narrow_fr)
save_button = Button(main_frame, text='СОХРАНЕНИЕ', bg='grey55', fg='white', width=30, command=save)
frame_label.pack()
search_button.pack()
add_button.pack()
edit_button.pack()
